...
const BIP39_WORDLIST = [
    ...
    'betray', 'better', 'between', 'beyond', 'bicycle', 'blanket', 'blast', 'bleak', 'bless', 'blind',
    'blood', 'blossom', 'blouse', 'blue', 'blur', 'blush', 'board', 'boat', 'body', 'boil',
    'bomb', 'bone', 'bonus', 'book', 'boost', 'border', 'bored', 'borrow', 'boss', 'bottom',
    'bounce', 'box', 'boy', 'bracket', 'brain', 'brand', 'brass', 'brave', 'bread', 'breeze',
    'brick', 'bridge', 'brief', 'bright', 'bring', 'brisk', 'broccoli', 'broken', 'bronze', 'broom',
    'brother', 'brown', 'brush', 'bubble', 'buddy', 'budget', 'buffalo', 'build', 'bulb', 'bulk',
    'bullet', 'bundle', 'bunker', 'burden', 'burger', 'burst', 'bus', 'business', 'busy', 'butter',
    'buyer', 'buzz', 'cabbage', 'cabin', 'cable', 'cactus', 'cage', 'cake', 'call', 'calm', 'camera',
    ...
    'cause', 'caution', 'cave', 'ceiling', 'celery', 'cement', 'census', 'century', 'cereal', 'chair',
    ...
    'donor', 'door', 'dose', 'double', 'dove', 'draft', 'dragon', 'drama', 'draw', 'dream',
    ...
    'edit', 'educate', 'effort', 'egg', 'eight', 'elbow', 'elder', 'electric', 'elegant', 'element',
    ...
    'forward', 'fossil', 'foster', 'found', 'fox', 'fragile', 'frame', 'franchise', 'frank', 'fresh',
    ...
    'gaze', 'general', 'genre', 'gentle', 'genuine', 'gesture', 'ghost', 'giant', 'gift', 'giggle',
    ...
    'hat', 'have', 'hawk', 'hazard', 'head', 'health', 'heart', 'heavy', 'hedge', 'height',
    ...
    'joy', 'judge', 'juggle', 'juice', 'jump', 'jungle', 'junior', 'junk', 'just', 'kangaroo',
    ...
    'mother', 'motion', 'motor', 'mountain', 'move', 'movie', 'much', 'muffin', 'mule', 'multiply',
    ...
    'rare', 'rate', 'rather', 'raven', 'raw', 'reach', 'react', 'read', 'real', 'reason',
    'rebel', 'rebuild', 'receipt', 'receive', 'recipe', 'record', 'recycle', 'red', 'reduce', 'reflect',
    'reform', 'refuge', 'refuse', 'region', 'regret', 'regular', 'reject', 'relax', 'release', 'relief',
    'rely', 'remain', 'remember', 'remind', 'remote', 'remove', 'render', 'renew', 'rent', 'reopen',
    'repair', 'repeat', 'replace', 'reply', 'report', 'represent', 'reptile', 'require', 'rescue', 'resemble',
    ...
    'tragic', 'train', 'transfer', 'trap', 'trash', 'travel', 'treat', 'tree', 'trend', 'trial',
    ...
    'used', 'useful', 'useless', 'utility', 'vacant', 'vacuum', 'vague', 'valid', 'valley', 'valve',
    'van', 'vanish', 'vapor', 'various', 'vegan', 'velvet', 'vendor', 'venture', 'venue', 'verb',
    'verify', 'version', 'very', 'vessel', 'veteran', 'vibrant', 'vicious', 'victory', 'video', 'view',
    'village', 'virtue', 'virus', 'visa', 'visit', 'visual', 'vital', 'vivid', 'vocal', 'voice',
    'void', 'volcano', 'volume', 'vote', 'voyage', 'wage', 'wagon', 'wait', 'walk', 'wall',
    'walnut', 'want', 'war', 'warm', 'warrior', 'wash', 'wasp', 'waste', 'water', 'wave',
...
export class KeyManager {
     ...
     */
    static encryptDatabaseKey(dbKey, masterKey) {
        try {
     ...
     * @returns 解密后的数据库密钥
     */
    static decryptDatabaseKey(encrypted, masterKey) {
        try {
     ...
     * @returns 24 个空格分隔的单词
     */
    static generateRecoveryKey(masterKey) {
     ...
     */
    static deriveFromRecoveryKey(recoveryKey) {
     ...
     * @returns Base64 编码的密文（IV + AuthTag + 密文）
     */
    static encryptContent(content, dbKey) {
        try {
            const iv = randomBytes(16);
     ...
     * @returns 解密后的明文
     */
    static decryptContent(encrypted, dbKey) {
        try {
            const data = Buffer.from(encrypted, 'base64');
            if (data.length < 32) {
                throw new CryptoError('密文格式无效：长度不足');
     ...
     * @returns 是否为加密格式
     */
    static isEncryptedContent(content) {
        try {
            // 基本检查：是否为有效 Base64
