...
describe('MacOSServiceManager', () => {
  ...
  it(
    ...
    { skip: !isMacOS },
    async () => {
      const { MacOSServiceManager } = await import('../../dist/service/macos.js')
...
describe('UnsupportedServiceManager', () => {
  it('install() returns success:false with error message', async () => {
    const { UnsupportedServiceManager } = await import('../../dist/service/unsupported.js')
...
describe('LinuxServiceManager', () => {
  it('install() returns success:false with not-implemented message', async () => {
    const { LinuxServiceManager } = await import('../../dist/service/linux.js')
  ...
  it('getStatus() returns success:false with not-implemented message', async () => {
    const { LinuxServiceManager } = await import('../../dist/service/linux.js')
    const mgr = new LinuxServiceManager()
