...
import type { MemoryIndexEntry } from '@/runtime/memory-index.js';
...
import { countAnchorMatches, hasChangeIntent, isDecisionBlock } from '@/runtime/scoring.js';
import { recallFromMemoryIndex } from '@/runtime/memory-index.js';
