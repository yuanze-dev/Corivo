import type { QueryPack } from '@/application/query/query-pack.js';
import type { CorivoSurfaceItem } from '@/runtime/types.js';
import { collectCandidates, type RuntimeDatabase } from '@/application/query/retrieval.js';
import { countAnchorMatches, isUnfinishedBlock } from '@/runtime/scoring.js';
