...
export async function generateOpencodePluginAsset(opencodeRoot = packageRoot) {
  ...
  const externalImports = [
    ...splitStandaloneImports(adapterModule.imports, 'packages/plugins/opencode/src/adapter.ts'),
    ...splitStandaloneImports(indexModule.imports, 'packages/plugins/opencode/src/index.ts'),
  ];
