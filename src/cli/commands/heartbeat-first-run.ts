...
firstRunCommand
  .description('首次运行 - 加速处理 Cold Scan 结果')
  ...
  .action(async (options) => {
    try {
      ...
      console.log(chalk.cyan('     Corivo 首次运行                   '));
      console.log(
        chalk.cyan('══════════════════════════════════════════')
      );
      console.log('');
      ...
      console.log(chalk.green('     首次运行完成                        '));
      console.log(chalk.green('══════════════════════════════════════════'));
      console.log('');
      console.log(`处理数量: ${result.processedBlocks}`);
      console.log(`耗时: ${result.elapsedTime}ms`);
      console.log('');
    } catch (error) {
